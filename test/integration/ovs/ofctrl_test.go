...
var (
	...
	ipDSCP = uint8(10)
	t0     = binding.NewOFTable(0, "t0", 0, 0)
	t1     = binding.NewOFTable(1, "t1", 0, 0)
	t2     = binding.NewOFTable(2, "t2", 0, 0)
	t3     = binding.NewOFTable(3, "t3", 0, 0)
	t4     = binding.NewOFTable(4, "t4", 0, 0)
)
