...
var (
	...
	//   - 0: from tunnel port.
	//   - 1: from Antrea gateway port.
	//   - 2: from local Pods.
	//   - 3: from uplink port.
	//   - 4: from bridge local port.
	...
	//   - 0: to tunnel port.
	//   - 1: to Antrea gateway port.
	//   - 2: to local Pods.
	//   - 3: to uplink port.
	//   - 4: to bridge local port.
...
var (
	...
	FromLocalCTMark       = binding.NewCTMark(ConnSourceCTMarkField, localVal)
	FromUplinkCTMark      = binding.NewCTMark(ConnSourceCTMarkField, uplinkVal)
